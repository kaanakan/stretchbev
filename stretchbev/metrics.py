...
class IntersectionOverUnion(Metric):
    ...
    def calculate_batch(self, prediction: torch.Tensor, target: torch.Tensor):
        self.reset()
...
class PanopticMetric(Metric):
    ...
    def calculate_batch(self, pred_instance, gt_instance):
        self.reset()
        self.update(pred_instance, gt_instance)
        return self.compute()
