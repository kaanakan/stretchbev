...
from stretchbev.utils.geometry import (
...
from stretchbev.utils.instance import convert_instance_mask_to_center_and_offset_label
from stretchbev.utils.lyft_splits import TRAIN_LYFT_INDICES, VAL_LYFT_INDICES
...
class FuturePredictionDataset(torch.utils.data.Dataset):
    def __init__(self, nusc, is_train, cfg):
        ...
        self.is_lyft = False  # isinstance(nusc, LyftDataset)
