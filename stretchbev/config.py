...
_C.MODEL.SMALL_ENCODER.SKIPCO = True


_C.MODEL.FIRST_STATE = CN()
_C.MODEL.FIRST_STATE.NUM_LAYERS = 3

_C.MODEL.DYNAMICS = CN()
_C.MODEL.DYNAMICS.NUM_LAYERS = 3
...
_C.MODEL.DISTRIBUTION.POSTERIOR_LAYERS = 2
_C.MODEL.DISTRIBUTION.PRIOR_LAYERS = 2
...
def get_parser():
    parser = argparse.ArgumentParser(description='Stretchbev training')
    # TODO: remove below?
